...
pipeline {
    ...
    environment {
        author_name = "Lisana"
        author_email = ""
        app_name = "housing_prediction_app"
        job_location = "Pipeline-as-code/DEEP-OC-org/{% if cookiecutter.git_base_url == 'https://github.com/deephdc' %}DEEP-OC-{{ cookiecutter.repo_name }}{% else -%}UC-{{ cookiecutter.git_base_url.split('/')[-1] }}-DEEP-OC-{{ cookiecutter.repo_name }}{% endif %}/${env.BRANCH_NAME}"
    }
